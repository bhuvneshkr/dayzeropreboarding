...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        speak_output = "Welcome to Day Zero! Are you starting as a New Hire soon or are you a Current Amazonian?"
...
sb.add_request_handler(RegisterRoleIntentHandler())
sb.add_request_handler(RegisterNewHireIntentHandler())
